...
printf("Interpolare Hermite cu noduri duble, noduri echidistante, nr_necesar noduri: %d\n", m_echi);
...
printf("Interpolare Hermite cu noduri duble, noduri Cebisev, nr_necesar noduri: %d\n", m_che);
