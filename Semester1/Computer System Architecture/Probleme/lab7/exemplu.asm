...
segment data use32 class=data
	sir  dq  1122334455667788h,1116adcb5a051ad2h,4120ca11d730cbb0h ;pt primul cuvant 22 reprezinta octetul inferior al cuvantului superior al dublucuvantului superior din elementele sirului de quadworduri
...
segment code use32 class=code
	...
	repeta:
		lodsd;in eax vom avea cuvantul mai putin semnificativ al dublucuvantului curent din sir
		lodsd;in eax vom avea cuvantul cel mai semnificativ al dublucuvantului curent din sir
		shr eax, 16
	...
	transf:
		div dword[zece];impartim la 10 numarul din registrul ca sa aflam ultima cifra
