...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','example.py',54),
  ('statement -> expression','statement',1,'p_statement_expr','example.py',58),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','example.py',62),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','example.py',63),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','example.py',64),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','example.py',65),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','example.py',72),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','example.py',76),
  ('expression -> NUMBER','expression',1,'p_expression_number','example.py',80),
  ('expression -> NAME','expression',1,'p_expression_name','example.py',84),
]
