...
static yyconst short int yy_base[19] =
    {   0,
        0,    0,   17,   18,    0,   14,    0,    0,   13,    9,
        0,    8,   18,   10,    4,    7,    7,    5
    } ;

static yyconst short int yy_def[19] =
    {   0,
       13,    1,   13,   13,   14,   15,   16,   17,   15,   18,
       17,   18,    0,   13,   13,   13,   13,   13
    } ;

static yyconst short int yy_nxt[24] =
    {   0,
        4,    4,    5,    6,    7,    9,    9,   12,   12,   11,
       10,    8,   10,   10,    8,    8,   13,    3,   13,   13,
       13,   13,   13
    } ;

static yyconst short int yy_chk[24] =
    {   0,
        1,    1,    1,    1,    1,   15,   15,   18,   18,   17,
       16,   14,   12,   10,    9,    6,    3,   13,   13,   13,
       13,   13,   13
    } ;
...
case 1:
YY_RULE_SETUP
#line 379 "flex_analizor.l"
{return CONSTANT;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 380 "flex_analizor.l"
{return IDENTIFIER;}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 381 "flex_analizor.l"
ECHO;
	YY_BREAK
#line 991 "lex.yy.c"
