...
namespace Async_Tasks {
    public static class AsyncTaskMechanism {
        ...
        private static async Task ConnectWrapper(Obj state) {
        ...
        private static async Task SendWrapper(Obj state, string data) {
        ...
        private static async Task ReceiveWrapper(Obj state) {
