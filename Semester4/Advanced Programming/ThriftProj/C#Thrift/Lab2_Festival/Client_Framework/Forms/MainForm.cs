...
namespace Lab2_Festival.Forms
{
    public partial class MainForm : Form, IObserver
    {
        ...
        public MainForm(IService festivalService)
        {
        ...
        {
            Console.WriteLine("MUIE MPP");
            BeginInvoke(new UpdateCallBack(this.Reload));
        }
        ...
        private void InitTable()
        {
            ...
            var concerts = _festivalService.GetConcertDtos();
            bindingSource.DataSource = concerts;
            mainTable.DataSource = bindingSource;
