...
begin
		...
		begin catch
			set @ok = 0
			rollback tran
			select 'Transaction rolled back at produse'
		end catch
		...
		begin catch
			rollback tran
			select 'Transaction rolled back at comanda'
		end catch
...
select * from Produse
select * from Comenzi
exec AddComanda2 'email@afds.com','04/04/2014','04/04/2014','CARD','ds','dsa',400
select * from Clienti
select * from Produse
select * from Comenzi
...
select * from Produse
select * from Comenzi
exec AddComanda2 'email@das.com','04/04/2014','04/04d/2014','CARD','ds','dsa',400
select * from Clienti
select * from Produse
select * from Comenzi