...
Revision ID: 489a7c58eee1
Revises: 
Create Date: 2019-06-16 14:30:24.543023
...
def upgrade():
    ...
    sa.Column('a1', sa.String(length=512), nullable=True),
    sa.Column('a2', sa.String(length=512), nullable=True),
    sa.Column('a3', sa.String(length=512), nullable=True),
